  ...
  return (
    ...
    >
      <Grid
        container
        spacing={2}
        sx={{ maxWidth: "1200px", margin: "0 auto", padding: "0px 120px" }}
      >
        <Grid item xs={12} md={6}>
          ...
          <Typography
            variant="body2"
            sx={{ lineHeight: 1.8, fontSize: "12px", maxWidth: "300px" }}
          >
            Binary Hub - Your Partner in Digital Transformation. Empowering
            businesses with innovative IT solutions.
          </Typography>
        </Grid>
